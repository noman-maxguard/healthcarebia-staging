...
(function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var h =
                            this.$.getBoundingClientRect(), m = d.$.documentElement, n = m.clientTop || g.$.clientTop || 0,
                        o = m.clientLeft || g.$.clientLeft || 0, l = true;
                    if (CKEDITOR.env.ie) {
    ...
    (function () {
        function b(a, b) {
            ...
            d = c.endContainer;
            var o = c.startOffset, l = c.endOffset, j, q = this.guard, f = this.type,
    ...
    (function () {
        function b() {
            var a = false, b = CKEDITOR.dom.walker.whitespaces(), l = CKEDITOR.dom.walker.bookmark(true),
        ...
        var f = function (a) {
            ...
            h = new CKEDITOR.dom.walker.bookmark, m = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                var b = this.startContainer, l = this.endContainer, c = this.startOffset, d = this.endOffset,
                    g = this.collapsed, f, i;
                ...
                if (a.is2) {
                    var b = this.document.getByAddress(a.start, a.normalized), l = a.startOffset,
                        c = a.end && this.document.getByAddress(a.end, a.normalized), a = a.endOffset;
                    this.setStart(b, l);
                ...
                var l = this.startContainer, c = this.endContainer,
                ...
                if (!this.collapsed) {
                    var a = a || CKEDITOR.SHRINK_TEXT, j = this.clone(), d = this.startContainer, g = this.endContainer,
            ...
            moveToPosition: function (a, b) {
                ...
                var b =
                    ...
                    c = new CKEDITOR.dom.elementPath(this.endContainer, this.root), j = b.block, d = c.block, g = null;
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, g) {
            ...
            var j = new CKEDITOR.htmlParser,
                ...
                y = [], z = [], i = q, s = q.name == "textarea", A = q.name == "pre";
    ...
    (function () {
        ...
        var s = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", B = CKEDITOR.dtd,
            p = ["caption", "colgroup", "col", "thead", "tfoot",
                "tbody"], E = CKEDITOR.tools.extend({}, B.$blockLimit, B.$block),
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, f = a.elementMode, m = a.fire("uiSpace", {space: "top", html: ""}).html,
                n = a.fireOnce("uiSpace", {space: "bottom", html: ""}).html;
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            f.on("contentDom", function () {
                var a = f.document, e = CKEDITOR.document, l = f.editable(), g = a.getBody(),
                    o = a.getDocumentElement(), h = l.isInline();
    ...
    (function () {
        ...
        var p = {
                ...
                audio: 1,
                video: 1
            }, u = /\s*(?:;\s*|$)/, r = /#\((.+?)\)/g, D = CKEDITOR.dom.walker.bookmark(0, 1),
...
*/
        ...
        requires: "panelbutton,floatpanel", init: function (c) {
            function j(k, i, e, g) {
                ...
                c.ui.add(k, CKEDITOR.UI_PANELBUTTON, {
                    ...
                    onOpen: function () {
                        var b = c.getSelection(), b = b && b.getStartElement(), b = c.elementPath(b), a,
                            b = b.block || b.blockLimit || c.document.getBody();
    ...
    (function () {
        ...
        function p(a) {
            var e, f = a.config, p = f.floatSpaceDockedOffsetX || 0, o = f.floatSpaceDockedOffsetY || 0,
                ...
                }, f = CKEDITOR.document.getBody(), r = {id: a.id, name: a.name, langDir: a.lang.dir, langCode: a.langCode},
            ...
            init: function (a) {
                if (!a.blockless) {
                    var c = new f(a, "justifyleft", "left"), b = new f(a, "justifycenter", "center"),
                        h = new f(a, "justifyright", "right"), d = new f(a, "justifyblock", "justify");
    ...
    (function () {
        ...
        var p = CKEDITOR.tools.extend, J = CKEDITOR.dom.element, A = J.createFromHtml, n = CKEDITOR.env,
            v = CKEDITOR.dtd, C = 128, V = 64, L = 32, F = 16, aa = 8, w = 4, x = 2, r = 1, D = " ", X = v.$listItem,
    ...
    (function () {
        var g, i = {
            modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function (a) {
                var b = a.config, e = b.baseHref ? '<base href="' + b.baseHref + '"/>' : "",
    ...
    (function () {
        ...
        function r(c, d, b) {
            ...
            for (var d =
                ...
                f = a[d];
                var n = f.getParent(), s = f.getFirst(), q = f.$.colSpan, t = f.$.rowSpan, n = n.$.rowIndex,
                    x = v(g, n, f), r = r + q * t, l = Math.max(l, x - k + q);
                w = Math.max(w, n - j + t);
                if (!b) {
                    q = f;
