        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-3">
                <a href="<?= base_url() ?>allergy-blood-testing-at-home-blog" class="card-style3 card-style4 same">
                    ...
                    <p>What can Allergy Blood Testing at Home actually detect? Explore panels, costs in Dubai, and how doctors interpret results.</p>
                </a>
            </div>
            ...
            <div class="col-md-3 mb-3">
                <a href="<?= base_url() ?>iv-drip-home-service-dubai" class="card-style3 card-style4 same">
                    ...
                    <p>Curious about getting an IV drip at home in Dubai? Discover what happens during your first visit, from consultation to infusion.</p>
                </a>
            </div>
            <div class="col-md-3 mb-3">
                ...
                class="card-style3 card-style4 same">
                    ...
                    <p>Step-by-step process, DHA safety rules, benefits, pricing, and FAQs for professional IV therapy delivered in your home.</p>
                </a>
            </div>
        </div>
    </div>
