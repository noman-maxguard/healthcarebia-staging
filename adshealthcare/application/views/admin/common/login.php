...
<title>Healthcarebia | Login</title>
...
<p class="">
   ...
   ?>
     <img style="width: 250px;" src="<?=base_url()?>uploads/header_logo/<?=$this->data['c_settings']->header_logo?>" alt="<?=$this->data['c_settings']->header_logo_alt?>">
...
<a href="auth_pass_recovery_boxed.html" class="forgot-pass-link"></a>
</div>
...
<!-- <p class="signup-link">Not registered ? <a href="<?=base_url()?>admin/register">Create an account</a></p> -->
...
$('.alert').delay(timeout).fadeOut(200);
});
</script>
</body>
