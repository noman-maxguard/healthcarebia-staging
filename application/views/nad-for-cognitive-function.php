            ...
            <div class="col-md-9">
                <div class="card-style3 card-style4 same">
                    ...
                    <ul class="ingredients-list">
                        ...
                        <li><strong>Resilience to Stress:</strong> By reducing oxidative damage and enhancing mitochondrial health, NAD+ supports resistance to both mental and physical burnout.</li>
                    ...
                    <ul class="tick-list">
                        ...
                        <li><a href="<?= base_url() ?>contact-us">Concierge-level service</a>, delivered discreetly wherever you are</li>
                    ...
                    <ul class="ingredients-list">
                        ...
                        <li>Explore our full <a href="<?= base_url() ?>iv-drip-dubai">IV+ Diagnostics Menu</a></li>
                    ...
                    <ol>
                        ...
                        <li>Martens, C. R. et al. (2018). Chronic nicotinamide riboside supplementation is well-tolerated and elevates NAD+ in healthy middle-aged and older adults. <em>Nature Communications</em>.</li>
                        <li>Rajman, L. et al. (2018). Therapeutic Potential of NAD-Boosting Molecules: The In Vivo Evidence. <em>Cell Metabolism</em>.</li>
                    </ol>
                </div>
            </div>
        </div>
