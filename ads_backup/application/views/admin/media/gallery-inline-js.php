...
<script>
    ...
    search = $('.search_txt').val();
        ...
        $.ajax({
            url: '<?php echo base_url('admin/media/get'); ?>?page=' + page + search_string,
            dataType: 'json',
            type: 'get',
    ...
    $(function(){
        ...
        $(".file-input-ajax").fileinput({
            uploadUrl: "<?php echo base_url('admin/media/upload'); ?>?m=<?php echo $module; ?>", // server upload action
            uploadAsync: true,
