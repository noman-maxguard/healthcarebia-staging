    ...
    <script type="application/ld+json">
{
  ...
  "description":"At-home anaemia evaluation including iron studies to investigate fatigue and low hemoglobin.",
  "url":"https://www.healthcarebia.ae/anaemia-profile",
  "isAccessibleForFree": false,
  "availableService": { "@type":"Service", "areaServed": { "@type":"City", "name":"Dubai" } },
  "offers": { "@type":"Offer", "priceCurrency":"AED", "url":"https://www.healthcarebia.ae/anaemia-profile" },
    ...
    <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 3,
      "name": "Anaemia Profile",
      "item": "https://healthcarebia.ae/anaemia-profile"
    }
  ]
}
</script>
                ...
                <div class="col-12"><h1>Anaemia Profile</h1>
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a href="<?= base_url() ?>women-health" class="hvr-underline-from-left menu-line">Women’s

                                    Health</a></li>

                            <li class="active" aria-current="page">Anaemia Profile</li>
...
<section class="section-gap">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-3"><img width="497" height="490" src="<?= base_url() ?>assets/frontend/img/anaemia.webp" alt="Anaemia Profile Dubai" class="img-fluid rounded "></div>

            <div class="col-md-7">

                <div class="inner-page-right">

                    <div class="mt-4"><p>The Anaemia Profile test is a diagnostic tool used in healthcare to assess red

                            blood cell health and other levels. It aids in identifying various forms of anemia and

                            provides essential insights into overall health. The test plays a crucial role in guiding

                            medical evaluations and treatment decisions.</p>

                        <ul class="listing-item3">

                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" width="30" height="30" alt="Anaemia Profile Dubai icon 1">5 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" width="30" height="30" alt="Anaemia Profile Dubai icon 2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" width="30" height="30" alt="Anaemia Profile Dubai icon 3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" width="30" height="30" alt="Anaemia Profile Dubai icon 4">DHA-licensed nurses & lab
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/results-icon.svg" width="30" height="30" alt="Anaemia Profile Dubai icon 5">Fast, secure,
