    ...
    <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "position": 2,
      "name": "Men’s Health",
      "item": "https://healthcarebia.ae/mens-health"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Custom Blood Test",
      "item": "https://healthcarebia.ae/custom-blood-test"
    }
  ]
}
</script>
    ...
    <div class="overlay">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12"><h2>Custom Blood Test</h2>
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active" aria-current="page">Custom Blood Test</li>
...
<section class="section-gap">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-3"><img width="497" height="490" src="<?= base_url() ?>assets/frontend/img/blood-test.webp" alt="Custom Blood Test Dubai" class="img-fluid rounded "></div>

            <div class="col-md-7">

                <div class="inner-page-right">

                    <div class="mt-4"><p>The Custom Blood Test offers personalized insights into your health, providing

                            a comprehensive analysis of various biomarkers. This non-invasive procedure helps healthcare

                            professionals assess your well-being and identify potential concerns. By analysing your

                            unique biochemistry, it empowers informed decisions and promotes proactive healthcare
                ...
                <div class="tabs-design">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade active show" id="nav-home" role="tabpanel"
                             ...
                             aria-labelledby="nav-home-tab"><p>Our DHA registered Doctors can advise the best profiles

                                and markers following a doctors consultation to ensure the most relevant results.</p>
