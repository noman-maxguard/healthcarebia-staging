                ...
                <div class="inner-page-right">
                    ...
                    <div class="mt-4"><p>A crucial step in proactive healthcare. This assessment aids in early detection
                        ...
                        <ul class="listing-item3">
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" alt="Basic Diabetes Screening Dubai Icon1">3 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" alt="Basic Diabetes Screening Dubai Icon2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" alt="Basic Diabetes Screening Dubai Icon3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" alt="Basic Diabetes Screening Dubai Icon4">DHA-licensed nurses & lab
