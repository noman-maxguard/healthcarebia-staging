...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "BlogPosting",
      "@id": "https://healthcarebia.ae/blog/myers-cocktail-iv-drip#blogpost",
      "headline": "From Fatigue to Focus: The Myers Cocktail IV Drip",
      "description": "Discover how the Myers Cocktail IV drip provides fast energy, mental clarity, and immunity boosting with at-home IV therapy by healthcarebia. Book your session today.",
      "image": "https://healthcarebia.ae/assets/frontend/img/blog-myers.jpg",
      "url": "https://healthcarebia.ae/blog/myers-cocktail-iv-drip",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://healthcarebia.ae/blog/myers-cocktail-iv-drip"
      }
    }
    </script>
...
<section class="sub-banner small-banner small-banner-inner"
         style="background-image: url(<?= base_url() ?>assets/frontend/img/myers-banner.jpg);">
            ...
            <div class="col-md-9">
                <div class="card-style3 card-style4 same">
                    ...
                    <ul class="ingredients-list">
                        ...
                        <li><b>B-complex vitamins</b> – enhance metabolism and nerve function</li>
                        <li><b>Magnesium</b> – helps relax muscles and reduce inflammation</li>
                        <li><b>Trace minerals</b> – provide balance for long-term health</li>
                    </ul>
                    ...
                    <ul class="tick-list">
                        ...
                        <li>Only DHA-approved <b>iv therapy solutions</b> are used</li>
                        <li>Appointments are flexible and easy to book</li>
                    ...
                    <ul class="ingredients-list">
                        ...
                        <li>Travel frequently and want relief from jet lag</li>
                        <li>Want immunity boosting during cold and flu season</li>
                        <li>Prefer <b>iv vitamin therapy</b> services that save time</li>
                    </ul>
                    ...
                    <ol>
                        ...
                        <li>Insertion. A small IV line is placed, and you begin to receive iv fluids with nutrients.</li>
                        <li>Infusion. The drip takes 45–60 minutes. Many clients read, rest, or work during this time.</li>
                        <li>After-care. The nurse removes the IV and provides follow-up advice.</li>
                    </ol>
                    ...
                    <ul class="ingredients-list">
                        ...
                        <li>Choose a comfortable space to relax</li>
                        <li>Use the infusion time productively or simply rest</li>
                    ...
                    <p><small>Disclaimer: This blog is for educational purposes and does not replace medical advice. Always consult a licensed practitioner if you have underlying conditions or are taking prescription medications.</small></p>
                </div>
            </div>
        </div>
    </div>
