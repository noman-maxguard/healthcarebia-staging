...
<script type="application/ld+json">
{
  ...
  "description":"At-home diabetes screen including glucose and HbA1c.",
  "url":"https://www.healthcarebia.ae/basic-diabetes-screening",
  "isAccessibleForFree": false,
  "availableService": { "@type":"Service", "areaServed": { "@type":"City", "name":"Dubai" } },
  "offers": { "@type":"Offer", "priceCurrency":"AED", "url":"https://www.healthcarebia.ae/basic-diabetes-screening" },
   ...
   <script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Basic Diabetes Screening", "item": "https://healthcarebia.ae/basic-diabetes-screening" }
  ]
}
</script>
    ...
    <div class="overlay">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12"><h2>Basic Diabetes Screening</h2>
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active" aria-current="page">Basic Diabetes Screening</li>
...
<section class="section-gap">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-3"><img width="497" height="490" src="<?= base_url() ?>assets/frontend/img/diabetes-screening.webp" alt="Basic Diabetes Screening Dubai" class="img-fluid rounded "></div>

            <div class="col-md-7">

                <div class="inner-page-right">

                    <div class="mt-4"><p>A crucial step in proactive healthcare. This assessment aids in early detection

                            of diabetes risk factors, focusing on key indicators like blood sugar levels and family

                            history. Prioritize your well-being by staying informed about your health status and making

                            informed decisions for a balanced lifestyle.</p>

                        <ul class="listing-item3">

                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" width="30" height="30" alt="Basic Diabetes Screening Dubai Icon1">3 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" width="30" height="30" alt="Basic Diabetes Screening Dubai Icon2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" width="30" height="30" alt="Basic Diabetes Screening Dubai Icon3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" width="30" height="30" alt="Basic Diabetes Screening Dubai Icon4">DHA-licensed nurses & lab
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/results-icon.svg" width="30" height="30" alt="Basic Diabetes Screening Dubai Icon6">Fast, secure,
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <ul class="listing-item4">
                                ...
                                <li>Adults over the age of 40 years should consider screening atleast once every 3

                                    years

                                </li>

                                <li>More than frequent urination</li>
