    ...
    <script type="application/ld+json">
{
  ...
  "description":"Private in-residence infusion formulated to support digestion, reduce bloating, and restore micronutrient balance.",
  "serviceType":"IV therapy",
  "url":"https://healthcarebia.ae/gut-health-iv-drip",
  "areaServed": { "@type":"City", "name":"Dubai" },
  "provider": { "@type":"MedicalOrganization", "name":"Healthcarebia", "url":"https://www.healthcarebia.ae" },
  "timeRequired": "PT90M",
  "offers": { "@type":"Offer", "priceCurrency":"AED", "price":"1900", "availability":"https://schema.org/InStock", "url":"https://healthcarebia.ae/gut-health-iv-drip" }
}
</script>
...
<div class="mob-inner-banner" style="background-image: url(<?= base_url() ?>assets/frontend/img/gut-health-banner-mob.webp);">
    <section class="sub-banner" style="background-image: url(<?= base_url() ?>assets/frontend/img/gut-health-banner.webp);">
        <div class="overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12"><h1>Gut Health IV Drip Dubai</h1>
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                ...
                                <li class="active" aria-current="page">Gut Health IV Drip</li>
                            </ul>
                        </nav>
                    </div>
                </div>
