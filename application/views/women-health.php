...
<section class="section-gap">
    <div class="container">
        <div class="row">
            <div class="col-md-5 mb-3"><img src="<?= base_url() ?>assets/frontend/img/female-cancer-screening.webp" width="497" height="490"
                ...
                <div class="inner-page-right">
                    <div class="mt-4"><p>Promoting women's health and well-being, female cancer screening tests are
                        ...
                        <ul class="listing-item3">
                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" width="30" height="30" alt="Female Cancer Screening Dubai icon 2">7 Biomarkers
                                tested
                            </li>
                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" width="30" height="30" alt="Female Cancer Screening Dubai icon 3"> Hormones,
                                Cholesterol, Blood Sugar & More
                            </li>
                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" width="30" height="30" alt="Female Cancer Screening Dubai icon 4">At home blood sample
                                collection
                            </li>
                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" width="30" height="30" alt="Female Cancer Screening Dubai icon 5">DHA-licensed nurses & lab
                                partners
                            </li>
                        </ul>
                    </div>
