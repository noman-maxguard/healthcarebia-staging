...
<script type="application/ld+json">
{
  ...
  "description":"Inflammatory and autoimmune markers to assess joint pain and arthritis risk.",
  "url":"https://www.healthcarebia.ae/arthritis-profile",
  "isAccessibleForFree": false,
  "availableService": { "@type":"Service", "areaServed": { "@type":"City", "name":"Dubai" } },
  "offers": { "@type":"Offer", "priceCurrency":"AED", "url":"https://www.healthcarebia.ae/arthritis-profile" },
                ...
                <div class="col-12"><h1>Arthritis Profile</h1>
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a class="hvr-underline-from-left menu-line">Common and Functional Tests</a>

                            </li>

                            <li class="active" aria-current="page">Arthritis Profile</li>
...
<section class="section-gap">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-3"><img width="497" height="490" src="<?= base_url() ?>assets/frontend/img/arthritis.webp" alt="Arthritis Profile Dubai" class="img-fluid rounded "></div>

            <div class="col-md-7">

                <div class="inner-page-right">

                    <div class="mt-4"><p>The Arthritis Test serves as a diagnostic tool to aid healthcare professionals

                            in identifying potential arthritis symptoms. By assessing various indicators, the test

                            contributes crucial insights to assist in accurate medical evaluations and tailored

                            treatment recommendations for individuals experiencing joint-related concerns.</p>

                        <ul class="listing-item3">

                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" width="30" height="30" alt="Arthritis Profile Dubai Icon1">6 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" width="30" height="30" alt="Arthritis Profile Dubai Icon2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" width="30" height="30" alt="Arthritis Profile Dubai Icon3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" width="30" height="30" alt="Arthritis Profile Dubai Icon4">DHA-licensed nurses & lab
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/results-icon.svg" width="30" height="30" alt="Arthritis Profile Dubai Icon6">Fast, secure,
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <ul class="listing-item4">
                                ...
                                <li>Sudden flare-up of pain in bones</li>
        ...
        <div class="row">
                ...
                <div class="accordion pt-md-3">
                    ...
                    <div class="accordion-box">
                        <div class="accordion-item">
                            <h3><span>1</span>What is the Arthritis Profile?</h3>
                    ...
                    <div class="accordion-box">
                        <div class="accordion-item">
                            <h3><span>2</span>What does the Arthritis Profile usually assess?</h3>
                            <span class="plus-minus"></span>
                        </div>
                        <div class="data" style="display: none;">
                    ...
                    <div class="accordion-box">
                        <div class="accordion-item">
                            <h3><span>3</span>Who might consider doing the Arthritis Profile?</h3>
                            <span class="plus-minus"></span>
                        </div>
                        <div class="data" style="display: none;">
            ...
            <div class="col-md-6">
                <div class="accordion pt-md-3">
                    ...
                    <div class="accordion-box">
                        <div class="accordion-item">
                            <h3><span>4</span>Does this profile diagnose the exact type of arthritis?</h3>
                            <span class="plus-minus"></span>
                        </div>
                        <div class="data" style="display: none;">
                    ...
                    <div class="accordion-box">
                        <div class="accordion-item">
                            <h3><span>5</span>How is the Arthritis Profile usually carried out?</h3>
                            <span class="plus-minus"></span>
                        </div>
                        <div class="data" style="display: none;">
