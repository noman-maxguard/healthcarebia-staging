...
class Media extends MY_Controller {
   ...
   /*==Display MEdia==*/
    public function index($category=''){
        ...
        $total = $this->Media_m->getmedia($cond, 0 ,false,true, true,$this->data['tbl_media']);
        
        $this->init_pagination(base_url('media'), $total);
        $mediaList = $this->Media_m->getmedia($cond, $offset,false,true, true,$this->data['tbl_media']);
       
        $data['mediaData'] = $mediaList;
        // echo"<pre>";
        // print_r($data['mediaData']);
        // exit;
        ...
        $data['add_custom_js'] = $this->load->view('admin/media/gallery-inline-js', ['module' => 'Common'], true);
        $data['template_file'] = 'admin/media/lists';

        $data['_view'] = 'admin/media/lists';
    ...
    public function sample(){
        ...
        $product_pic_info = $this->Media_m->getmedia(['status'=>1],0,true,true,true,$this->data['tbl_media']);
    ...
    public function get() {
        ...
        $modules = $this->Media_m->getmediacategory($this->data['tbl_media']);
        ...
        $total_images = $this->Media_m->getmedia($cond, 0, false, true,$this->data['tbl_media']);
        $mediaList = $this->Media_m->getmedia($cond, $offset,$this->data['tbl_media']);
        $imgArr = [];
        if(!empty($mediaList)){
    ...
    public function upload(){
        ...
        if(!empty($_FILES['upload_img']))
        {
           ...
           $upload_path = FCPATH.'assets/cdn/uploads/'.$date;

             // echo"<pre>";
             // print_r($upload_path);
             // exit;
           
           $upload_path_base_url =  FCPATH.'assets/cdn/uploads/'.$date.'/';
    ...
    public function delete($media_id){
        ...
        $mediaInfo = $this->Media_m->getmedia(['media_id' => $media_id], 0, true,$this->data['tbl_media']);
        if(!empty($mediaInfo)){
