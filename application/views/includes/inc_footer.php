        ...
        <div class="row">
            <div class="col-md-4 footer-banner">
                ...
                <div href="#" class="google-reviews" style="display: flex; align-items: center">
                    ...
                    <div class="icon-box"><div class="images"><img src="<?= base_url() ?>assets/frontend/img/dha.svg" alt="dha" width="50" height="50"><img id="fda" src="<?= base_url() ?>assets/frontend/img/fda.png" alt="fda"><img src="<?= base_url() ?>assets/frontend/img/nabidh.svg" alt="nabidh"></div></div>
