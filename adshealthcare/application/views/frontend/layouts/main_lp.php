...
<header class="header">	
	...
	<div class="container">
        ...
        <img width="118" height="131" class="img-fluid" src="<?=base_url()?>assets/frontend/landingpage/img/logo.svg" alt="Best IV Drip Dubai"></a>



		<ul class="header-right">

			<li class="d-none d-md-block"><a href="tel:<?=!empty($this->data['c_settings']->mobile_one)?$this->data['c_settings']->mobile_one:''?>" class="link"><i class="fas fa-phone"></i> <?=!empty($this->data['c_settings']->mobile_one)?$this->data['c_settings']->mobile_one:''?></a></li>

			<li><a href="mailto:<?=!empty($this->data['c_settings']->email_two)?$this->data['c_settings']->email_two:''?>" class="link"><i class="fas fa-envelope"></i> <?=!empty($this->data['c_settings']->email_two)?$this->data['c_settings']->email_two:''?></a></li>
        ...
        ?>
			...
			<div class="col-lg-6">
				...
				<div class="contact-form">
					...
					<form class="row request-form contact_form_footer" method="post">
			...
			<div class="col-lg-6">
				...
				<div class="footer-right ps-xl-4">
...
<!--								</li>-->
								...
								<li>
									...
									<a href="mailto:<?=!empty($this->data['c_settings']->email_two)?$this->data['c_settings']->email_two:''?>">

										<i class="fas fa-envelope"></i>

										<?=!empty($this->data['c_settings']->email_two)?$this->data['c_settings']->email_two:''?>
						...
						<div class="col-md-6">
							...
							<ul class="footer-contact">
								...
								<li>
									...
									<a target="_blank" href="https://www.healthcarebia.ae/terms-and-conditions">
								...
								<li>
									...
									<a target="_blank" href="https://www.healthcarebia.ae/patient-rights">
								...
								<li>
									...
									<a target="_blank" href="https://www.healthcarebia.ae/cancellation-refund-policy">
						...
						<div class="col-md-12">
							...
							<div class="social-media">
								...
								<a target="_blank" href="https://www.facebook.com/people/Healthcarebia/100091624650304/">

									<i class="fab fa-facebook"></i>

								</a>

								<a target="_blank" href="https://www.instagram.com/p/CozTOq6pIPZ/">

									<i class="fab fa-instagram"></i>

								</a>

								<a target="_blank" href="https://www.linkedin.com/company/healthcarebia/">
							...
							<p class="copy-right">Copyright © 2023 healthcarebia | All rights reserved.</p>
