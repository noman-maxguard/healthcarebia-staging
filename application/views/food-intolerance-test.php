                ...
                <div class="col-12"><h2>Food Intolerance - Extended (200+ foods) </h2>
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active" aria-current="page">Food Intolerance - Extended (200+ foods)</li>
...
<section class="section-gap">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-3"><img width="497" height="490" src="<?= base_url() ?>assets/frontend/img/food-intolerance.webp" alt="Food Intolerance - Extended (200+ foods) Dubai" class="img-fluid rounded "></div>

            <div class="col-md-7">

                <div class="inner-page-right">

                    <div class="mt-4"><p>200+ Food Allergy Test. Uncover potential sensitivities and make informed

                            dietary choices. This test provides valuable insights into your well-being without

                            emphasizing sales, allowing you to prioritize your health and comfort.</p>

                        <ul class="listing-item3">

                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" width="30" height="30" alt="Food Intolerance - Extended (200+ foods) Dubai Icon1">1 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" width="30" height="30" alt="Food Intolerance - Extended (200+ foods) Dubai Icon2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" width="30" height="30" alt="Food Intolerance - Extended (200+ foods) Dubai Icon3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" width="30" height="30" alt="Food Intolerance - Extended (200+ foods) Dubai Icon4">DHA-licensed nurses & lab
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/results-icon.svg" width="30" height="30" alt="Food Intolerance - Extended (200+ foods) Dubai Icon6">Fast, secure,
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade active show" id="nav-home" role="tabpanel"
                            ...
                            <ul class="listing-item4">
                                ...
                                <li>Food Intolerance 200+ Foods</li>
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <ul class="listing-item4">
                                ...
                                <li>Experience of digestive discomfort such as bloating</li>
