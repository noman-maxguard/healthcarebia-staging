                ...
                <div class="inner-page-right">
                    ...
                    <div class="mt-4"><p>An insightful exploration aiming to understand the multifaceted causes and
                        ...
                        <ul class="listing-item3">
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" alt="Acne Investigation Dubai Icon1">4 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" alt="Acne Investigation Dubai Icon2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" alt="Acne Investigation Dubai Icon3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" alt="Acne Investigation Dubai Icon4">DHA-licensed nurses & lab
