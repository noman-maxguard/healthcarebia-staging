                ...
                <div class="col-12"><h2>Acne Investigation</h2>
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li><a href="<?= base_url() ?>allergy-test-general" class="hvr-underline-from-left menu-line">Allergy & Food Intolerance Tests</a></li>

                            <li class="active" aria-current="page">Acne Investigation</li>
...
<section class="section-gap">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-3"><img width="497" height="490" src="<?= base_url() ?>assets/frontend/img/allergy-food-intolerance.webp" alt="Acne Investigation Dubai" class="img-fluid rounded">
            ...
            <div class="col-md-7">
                ...
                <div class="inner-page-right">
                    ...
                    <div class="mt-4"><p>An insightful exploration aiming to understand the multifaceted causes and

                            potential remedies of acne. This comprehensive analysis sheds light on various factors

                            contributing to the condition, fostering a deeper comprehension of its complexities and

                            potential avenues for effective management.</p>

                        <ul class="listing-item3">

                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" width="30" height="30" alt="Acne Investigation Dubai Icon1">4 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" width="30" height="30" alt="Acne Investigation Dubai Icon2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" width="30" height="30" alt="Acne Investigation Dubai Icon3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" width="30" height="30" alt="Acne Investigation Dubai Icon4">DHA-licensed nurses & lab
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/results-icon.svg" width="30" height="30" alt="Acne Investigation Dubai Icon6">Fast, secure,
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <ul class="listing-item4">
                                ...
                                <li>Excessively Oily Skin.</li>

                                <li>Excessive inflammation.</li>

                                <li>Acne on other areas of the body such as face, back, shoulders or more.</li>
