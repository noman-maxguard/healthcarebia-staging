...
<div class="mob-inner-banner" style="background-image: url(<?= base_url() ?>assets/frontend/img/immune-banner-mob.webp);">
    <section class="sub-banner" style="background-image: url(<?= base_url() ?>assets/frontend/img/immune-banner.webp);">
        <div class="overlay">
            <div class="container">
                <div class="row">
                    <div class="col-12"><h1>Immune System Boost IV Drip Dubai</h1>
            ...
            <div class="row mt-4">
                <div class="col-6 col-md-3 mb-3">
                    <div class="therapy-choose-item">
                        <div class="img">
                            <img src="<?= base_url() ?>assets/frontend/img/dha.svg" width="52" height="62"alt="Immune System Boost IV Drip Dubai icon1" loading="lazy">
                        </div>
                        <div class="text">
                ...
                <div class="col-6 col-md-3 mb-3">
                    <div class="therapy-choose-item">
                        <div class="img">
                            <img src="<?= base_url() ?>assets/frontend/img/tick.svg" width="52" height="62"alt="Immune System Boost IV Drip Dubai icon2" loading="lazy">
                        </div>
                        <div class="text">
                ...
                <div class="col-6 col-md-3 mb-3">
                    <div class="therapy-choose-item">
                        <div class="img">
                            <img src="<?= base_url() ?>assets/frontend/img/like.svg" width="52" height="62"alt="Immune System Boost IV Drip Dubai icon3" loading="lazy">
                        </div>
                        <div class="text">
                ...
                <div class="col-6 col-md-3 mb-3">
                    <div class="therapy-choose-item">
                        <div class="img">
                            <img src="<?= base_url() ?>assets/frontend/img/customers.svg" width="52" height="62"alt="Immune System Boost IV Drip Dubai icon4" loading="lazy">
                        </div>
                        <div class="text">
                ...
                <div class="col-6 col-md-3 mb-3">
                    <div class="therapy-choose-item">
                        <div class="img">
                            <img src="<?= base_url() ?>assets/frontend/img/patient-care.svg" width="52" height="62"alt="Immune System Boost IV Drip Dubai icon5" loading="lazy">
                        </div>
                        <div class="text">
                ...
                <div class="col-6 col-md-3 mb-3">
                    <div class="therapy-choose-item">
                        <div class="img">
                            <img src="<?= base_url() ?>assets/frontend/img/reviews.svg" width="52" height="62"alt="Immune System Boost IV Drip Dubai icon6" loading="lazy">
                        </div>
                        <div class="text">
                ...
                <div class="col-6 col-md-3 mb-3">
                    <div class="therapy-choose-item">
                        <div class="img">
                            <img src="<?= base_url() ?>assets/frontend/img/available.svg" width="52" height="62"alt="Immune System Boost IV Drip Dubai icon7" loading="lazy">
                        </div>
                        <div class="text">
...
<section class="faq-block section-gap">
    <div class="container">
        <h2>Immune Boost IV Drip: Your Questions Answered</h2>
        <div class="row">
            <div class="col-md-6">
