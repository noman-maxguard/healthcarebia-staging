...
// $config['subclass_prefix'] = array('MY_','Core_');
...
if(stripos($_SERVER["REQUEST_URI"],'/login') !== FALSE || stripos($_SERVER["REQUEST_URI"],'/register') !== FALSE || stripos($_SERVER["REQUEST_URI"],'/package') !== FALSE)
{
