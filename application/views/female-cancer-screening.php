                ...
                <div class="inner-page-right">
                    ...
                    <div class="mt-4"><p>Promoting women's health and well-being, female cancer screening tests are
                        ...
                        <ul class="listing-item3">
                            ...
                            <li><img src="<?= base_url() ?>assets/frontend/img/biomarkers.svg" alt="Female Cancer Screening Dubai icon 1">7 Biomarkers

                                tested

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/hormones.svg" alt="Female Cancer Screening Dubai icon 2"> Hormones,

                                Cholesterol, Blood Sugar & More

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/home.svg" alt="Female Cancer Screening Dubai icon 3">At home blood sample

                                collection

                            </li>

                            <li><img src="<?= base_url() ?>assets/frontend/img/dha.svg" alt="Female Cancer Screening Dubai icon 4">DHA-licensed nurses & lab
